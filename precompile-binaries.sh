...
# rm $HOME/ghc/bin/hp*
# rm -r $HOME/ghc/lib/ghc-7.6.3/hp*
# rm -r $HOME/ghc/lib/ghc-7.6.3/package.conf.d/hpc-0.5.1.1-*
# rm -r $HOME/ghc/lib/ghc-7.6.3/ghc-7.6.3
# rm -r $HOME/ghc/lib/ghc-7.6.3/package.conf.d/ghc-7.6.3-*
# rm -r $HOME/ghc/lib/ghc-7.6.3/package.conf.d/package.cache
...
# cabal-install
curl --silent http://hackage.haskell.org/packages/archive/cabal-install/1.18.0.1/cabal-install-1.18.0.1.tar.gz|tar xz
